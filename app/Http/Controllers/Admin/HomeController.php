...
class HomeController
{
    ...
    {
        $settings1 = [
            'chart_title'           => 'New Enquiries Today',
            'chart_type'            => 'number_block',
            'report_type'           => 'group_by_date',
            'model'                 => 'App\Models\ContactEnquiry',
            ...
            'entries_number'        => '5',
            'translation_key'       => 'contactEnquiry',
        ];
        ...
        $settings2 = [
            'chart_title'           => 'Dealership Leads Today',
            'chart_type'            => 'number_block',
            'report_type'           => 'group_by_date',
            'model'                 => 'App\Models\DealershipApplication',
            'group_by_field'        => 'created_at',
            'group_by_period'       => 'day',
            'aggregate_function'    => 'count',
            'filter_field'          => 'created_at',
            ...
            'column_class'          => 'col-md-3',
            'entries_number'        => '5',
            'translation_key'       => 'dealershipApplication',
        ];
        ...
        $settings3 = [
            'chart_title'           => 'AMC Requests Today',
            'chart_type'            => 'number_block',
            'report_type'           => 'group_by_date',
            'model'                 => 'App\Models\AmcEnquiry',
            'group_by_field'        => 'created_at',
            'group_by_period'       => 'day',
            'aggregate_function'    => 'count',
            'filter_field'          => 'created_at',
        ...
        $settings4 = [
            'chart_title'           => 'Upgrade Requests Today',
            'chart_type'            => 'number_block',
            'report_type'           => 'group_by_date',
            'model'                 => 'App\Models\UpgradeRequest',
            'group_by_field'        => 'created_at',
            'group_by_period'       => 'day',
            'aggregate_function'    => 'count',
            'filter_field'          => 'created_at',
            ...
            'column_class'          => 'col-md-3',
            'entries_number'        => '5',
            'translation_key'       => 'upgradeRequest',
        ];
        ...
        $settings5 = [
            'chart_title'           => 'Bulk Quote Requests Today',
            'chart_type'            => 'number_block',
            'report_type'           => 'group_by_date',
            'model'                 => 'App\Models\BulkQuoteRequest',
            'group_by_field'        => 'created_at',
            'group_by_period'       => 'day',
            'aggregate_function'    => 'count',
            'filter_field'          => 'created_at',
            ...
            'column_class'          => 'col-md-3',
            'entries_number'        => '5',
            'translation_key'       => 'bulkQuoteRequest',
        ];
        ...
        $settings6 = [
            'chart_title'           => 'Downloads Unlocked Today',
            'chart_type'            => 'number_block',
            'report_type'           => 'group_by_date',
            'model'                 => 'App\Models\DownloadRequest',
            'group_by_field'        => 'created_at',
            'group_by_period'       => 'day',
            'aggregate_function'    => 'count',
            'filter_field'          => 'created_at',
            ...
            'column_class'          => 'col-md-3',
            'entries_number'        => '5',
            'translation_key'       => 'downloadRequest',
        ];
        ...
        $settings8 = [
            'chart_title'           => 'Revenue This Month',
            'chart_type'            => 'number_block',
            'report_type'           => 'group_by_date',
            'model'                 => 'App\Models\Order',
            'group_by_field'        => 'created_at',
