...
class AddressesController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        if ($request->ajax()) {
            $query = Address::with(['user'])->select(sprintf('%s.*', (new Address)->table));
            ...
            $table->editColumn('line_1', function ($row) {
                return $row->line_1 ? $row->line_1 : '';
            });
            $table->editColumn('line_2', function ($row) {
                return $row->line_2 ? $row->line_2 : '';
            });
            ...
            $table->editColumn('is_default', function ($row) {
                return $row->is_default ? Address::IS_DEFAULT_SELECT[$row->is_default] : '';
            });
