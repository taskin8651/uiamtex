...
class CategoriesController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        if ($request->ajax()) {
            ...
            // ✅ APPLY STATUS FILTER (coming from your AJAX: d.amtex_status)
            if ($request->filled('amtex_status')) {
                $query->where('is_active', $request->amtex_status);
            }
            ...
            $table->editColumn('is_active', fn($row) => $row->is_active ? Category::IS_ACTIVE_SELECT[$row->is_active] : '');
    ...
    public function store(StoreCategoryRequest $request)
    {
        ...
        if ($request->input('image', false)) {
            $category->addMedia(storage_path('tmp/uploads/' . basename($request->input('image'))))
