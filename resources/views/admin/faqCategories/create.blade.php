...
<div class="amtex-faqcat-form">
    ...
    <div class="af-header">
        <div>
            <h3 class="af-title">{{ trans('global.create') }} {{ trans('cruds.faqCategory.title_singular') }}</h3>
            <p class="af-subtitle">Create a category to organize FAQs cleanly and keep sorting consistent.</p>
        </div>
                ...
                <div class="card af-card">
                    <div class="card-header">
                        <div>
                            ...
                            <div class="af-section-hint">Fill in the basic details for this FAQ category.</div>
                        </div>
                    </div>
                    ...
                    <div class="card-body">
                        ...
                        <div class="af-note">
                            <strong>Tip</strong>
                            Use lower sort order to show the category earlier on the FAQ page (example: 1, 2, 3...).
                        </div>
                    </div>
                </div>
            </div>
