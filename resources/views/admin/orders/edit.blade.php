    ...
    <div class="card-body">
        <form method="POST" action="{{ route("admin.orders.update", [$order->id]) }}" enctype="multipart/form-data">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('order_no') ? 'is-invalid' : '' }}" type="text" name="order_no" id="order_no" value="{{ old('order_no', $order->order_no) }}" required>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('subtotal') ? 'is-invalid' : '' }}" type="text" name="subtotal" id="subtotal" value="{{ old('subtotal', $order->subtotal) }}" required>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('shipping') ? 'is-invalid' : '' }}" type="text" name="shipping" id="shipping" value="{{ old('shipping', $order->shipping) }}" required>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('tax') ? 'is-invalid' : '' }}" type="text" name="tax" id="tax" value="{{ old('tax', $order->tax) }}" required>
                @if($errors->has('tax'))
                    <div class="invalid-feedback">
                        {{ $errors->first('tax') }}
                    </div>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('total') ? 'is-invalid' : '' }}" type="text" name="total" id="total" value="{{ old('total', $order->total) }}" required>
                @if($errors->has('total'))
                    <div class="invalid-feedback">
                        {{ $errors->first('total') }}
                    </div>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('payment_status') ? 'is-invalid' : '' }}" type="text" name="payment_status" id="payment_status" value="{{ old('payment_status', $order->payment_status) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('txn') ? 'is-invalid' : '' }}" type="text" name="txn" id="txn" value="{{ old('txn', $order->txn) }}">
                @if($errors->has('txn'))
                    <div class="invalid-feedback">
                        {{ $errors->first('txn') }}
                    </div>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('address_snapshot') ? 'is-invalid' : '' }}" type="text" name="address_snapshot" id="address_snapshot" value="{{ old('address_snapshot', $order->address_snapshot) }}">
