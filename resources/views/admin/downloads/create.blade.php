...
<div class="amtex-page">
    ...
    <div class="amtex-header">
        <div>
            <h2 class="amtex-title">{{ trans('global.create') }} {{ trans('cruds.download.title_singular') }}</h2>
            <p class="amtex-subtitle">Add a downloadable document (PDF/brochure/profile) and control its visibility.</p>
        </div>
    ...
    <div class="amtex-card">
        <div class="amtex-card-head d-flex justify-content-between align-items-center">
            ...
            <span class="amtex-chip">Create</span>
        </div>
