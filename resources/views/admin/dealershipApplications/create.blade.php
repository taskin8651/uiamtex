...
<div class="card">
    <div class="card-header">
        {{ trans('global.create') }} {{ trans('cruds.dealershipApplication.title_singular') }}
    </div>

    <div class="card-body">
        <form method="POST" action="{{ route("admin.dealership-applications.store") }}" enctype="multipart/form-data">
            @csrf
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('city_state') ? 'is-invalid' : '' }}" type="text" name="city_state" id="city_state" value="{{ old('city_state', '') }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('business_type') ? 'is-invalid' : '' }}" type="text" name="business_type" id="business_type" value="{{ old('business_type', '') }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('sales_focus') ? 'is-invalid' : '' }}" type="text" name="sales_focus" id="sales_focus" value="{{ old('sales_focus', '') }}">
