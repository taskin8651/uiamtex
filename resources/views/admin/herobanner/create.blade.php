...
<div class="card hero-create-card">
    <div class="card-header d-flex align-items-center justify-content-between flex-wrap gap-2">
        <div>
            <strong>Create Home Hero Slide</strong>
            <div class="text-muted small mt-1">Add a new homepage hero banner with images, text, CTA and ordering.</div>
        </div>
    ...
    <div class="card-body">
        <form method="POST" action="{{ route('admin.home-heroes.store') }}" enctype="multipart/form-data" id="heroCreateForm">
            @csrf
                    ...
                    <div class="card inner-card mb-3">
                        ...
                        <div class="card-body">
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input
                                            ...
                                            name="badge_icon"
                                            id="badge_icon"
                                            value="{{ old('badge_icon', 'bi bi-shield-check') }}"
                                            placeholder="Example: bi bi-megaphone"
                                        >
                                        @if($errors->has('badge_icon'))
                                            <div class="invalid-feedback">{{ $errors->first('badge_icon') }}</div>
                                        @endif
                                        <small class="text-muted">Bootstrap icon class (e.g., <code>bi bi-megaphone</code>).</small>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="row g-2">
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        @endif
                                        <small class="text-muted">Shown highlighted (inside <code>&lt;span&gt;</code>).</small>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                @endif
                                <small class="text-muted">You can keep it simple text. (Optional: allow basic HTML if your frontend renders it.)</small>
                            </div>
                            ...
                            <div class="row g-2">
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        @endif
                                        <small class="text-muted">Small line shown near CTA.</small>
                                    </div>
                                </div>
                ...
                <div class="col-12 col-lg-4">
                    ...
                    <div class="card inner-card mb-3">
                        ...
                        <div class="card-body">
                            ...
                            {{-- Desktop image --}}
                            <div class="form-group">
                                <label for="desktop_image" class="required">Desktop Image</label>
                                <input
                                ...
                                @endif
                                <small class="text-muted">Recommended: 1920×700 or similar wide banner.</small>
                            ...
                            {{-- Mobile image --}}
                            <div class="form-group">
                                <label for="mobile_image" class="required">Mobile Image</label>
                                <input
                                ...
                                @endif
                                <small class="text-muted">Recommended: 900×1100 or similar portrait.</small>
...
@parent
<style>
    .hero-create-card .inner-card { border: 1px solid rgba(0,0,0,.08); }
    .hero-actions-sticky{
        position: sticky;
        bottom: 0;
        background: #fff;
