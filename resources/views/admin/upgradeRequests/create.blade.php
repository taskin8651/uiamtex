...
<div class="card">
    <div class="card-header">
        {{ trans('global.create') }} {{ trans('cruds.upgradeRequest.title_singular') }}
    </div>

    <div class="card-body">
        <form method="POST" action="{{ route("admin.upgrade-requests.store") }}" enctype="multipart/form-data">
            @csrf
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('current_extinguisher_type') ? 'is-invalid' : '' }}" type="text" name="current_extinguisher_type" id="current_extinguisher_type" value="{{ old('current_extinguisher_type', '') }}">
            ...
            <div class="form-group">
                ...
                <textarea class="form-control {{ $errors->has('admin_notes') ? 'is-invalid' : '' }}" name="admin_notes" id="admin_notes">{{ old('admin_notes') }}</textarea>
